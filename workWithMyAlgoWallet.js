...
let signedOptTxn = await myalgoConnect.signTransaction(optInTxn); 
...
let optSentTx=await client.sendRawTransaction(signedOptTxn.blob).do();
...
let signedTxns = await myalgoConnect.signTransaction([txns[1], txns[2], txns[3],txns[4],txns[5],txns[6],txns[7],txns[8],txns[9]]);
